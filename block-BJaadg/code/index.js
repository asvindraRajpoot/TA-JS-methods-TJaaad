...
console.log(quoteSplitted);
console.log(quoteSplitted.reduce((acc,ele)=>acc+" " +ele +" "),"");
/*
...
*/
console.log(quote.lastIndexOf('a',45));
/*
...
let newVar='';
if(quote.length<70){
  newVar= quote.padEnd((70-quote.length)*3.5,'.');
}
console.log(newVar);
/*
...
let newVar2='';
if(quote.length<70){
  newVar2= quote.padStart((70-quote.length)*3.5,'.');
}
console.log(newVar2);
/*
